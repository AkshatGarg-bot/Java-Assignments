...
public class DemoDriver implements AppControl {
	...
	public static void main(String[] args) {
		...
		// the group
		demoFactories.add(new demo19007.FactoryDemo());
		demoFactories.add(new demo19033.FactoryDemo());
		demoFactories.add(new demo19040.FactoryDemo());
		demoFactories.add(new demo19063.FactoryDemo());
		demoFactories.add(new demo19033.FactoryDemo());
		demoFactories.add(new demo19007.FactoryDemo());
